...
class MicrocontrollerDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #capture the corresponding XML file for get annotations
        ...
        #box co-ordinates for xml files are extracted and corrected for image size given
...
if __name__ == "__main__":
    #sanity check of the Dataset pipeline with simple visualization
    ...
    #function to visualize the single image
